...
DetectorConstruction::DetectorConstruction()
    : air(0), argongas(0), scintillator(0), CsI(0), lead(0), detSide1(160.0 * cm), detSide2(90.0 * cm),
      detSide3(160.0 * cm), detSide4(60.0 * cm), detHeight(5.0 * cm), deltaDet(3.0 * cm), deltaStacks(45.0 * cm),
      objLen(10.0 * cm), objWid(10.0 * cm), objHt(10.0cm), numDet(6), numChanPerDet(32), worldVisAtt(0),
      hodoscopeVisAtt(0), chamberVisAtt(0)
{
}
...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    G4LogicalVolume* hodoscopeLogical = new G4LogicalVolume(hodoscopeSolid, scintillator, "hodoscopeogical", 0, 0, 0);
